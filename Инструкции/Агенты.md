...
└── pages/
    ...
    │   ├── Authorization.tsx                  — ...
    │   ├── Login.tsx                          — ...
    │   ├── RasswordRecovery.tsx               — ...
    │   ├── Select Profile.tsx                 — ...
    │   ├── AuthorizationSocialID.tsx          — ...
    │   └── Registration.tsx                   — ...
    ├── ID
    │   ├── forms/
    │   │   ├── Contacts.tsx                   — ...
    ...
    │   ├── cards/
    │   │   ├── Card Details.tsx               — ...
    │   │   ├── CardTariffsandConditions.tsx   — ...
    │   │   ├── ContactlessPayment.tsx         — ...
    │   │   ├── СardBlock.tsx                  — ...
    │   │   ├── ReplaceСard.tsx                — ...
    │   │   ├── CardPinCode.tsx                — ...
    │   │   ├── CardLimits.tsx                 — ...
    │   │   ├── RegistrationNewCard.tsx        — ...
    │   │   ├── СardAllProducts.tsx            — ...
    │   │   ├── CardForSomeone.tsx             — ...
    │   │   ├── CardDebit.tsx                  — ...
    │   │   ├── CardDesign.tsx                 — ...
    │   │   ├── CardSearch.tsx                 — ...
    │   │   ├── CardDeliveryDetails.tsx        — ...   
    │   │   ├── CardDelivery.tsx               — ...
    │   │   └── CardСonfirmation.tsx           — ...
    │   └── loans/
    │       └── BNPL.tsx
    ├── finance/
