...
└── pages/
    ...
    ├── ID
    │   ├── forms/
    │   │   ├── Contacts.tsx                   — /ID/forms/contacts
    │   │   ├── PersonalData.tsx               — /ID/forms/personal-data
    │   │   ├── Job.tsx                        — /ID/forms/jobs
    │   │   ├── Income.tsx                     — /ID/forms/income
    │   │   ├── Additional.tsx                 — /ID/forms/additional
    │   │   ├── ObjectOfInsurance.tsx          — /ID/forms/object-of-Insurance
    │   │   ├── Mortgage.tsx                   — /ID/forms/mortgage
    │   │   ├── OSAGO.tsx                      — /ID/forms/osago
    │   │   └── KASKO.tsx                      — /ID/forms/kasko
    │   ├── summary/
    │   │   ├── Items.tsx                      — /ID/summary/items:
    │   │   ├── Loan.tsx                       — /ID/summary/loan:
    │   │   ├── CreditCard.tsx                 — /ID/summary/credit-card:
    │   │   ├── CarLoan.tsx                    — /ID/summary/car-loan:
    │   │   ├── MicroLoan.tsx                  — /ID/summary/micro-loan:
    │   │   ├── Instalment.tsx                 — /ID/summary/instalment:
    │   │   ├── Mortgage.tsx                   — /ID/summary/mortgage:
    │   │   ├── MortgageInsurance.tsx          — /ID/summary/mortgage-insurance:
    │   │   ├── OSAGO.tsx                      — /ID/summary/OSAGO:
    │   │   └── KASKO.tsx                      — /ID/summary/KASKO:
    │   └── wallet/
    ...
    ├── delivery/
    │   ├── ChoosingPoint.tsx                  — /delivery/choosing-point:
    │   ├── DeliveryMethod.tsx                 — /delivery/delivery-method:
    │   └── MakingAnOrder.tsx                  — /delivery/making-an-order:
    ├── 2FA
    │   ├── PhoneNumber.tsx                    — /2fa/phone-number: ввод номера телефона
    │   └── ValidationCode.tsx                 — /2fa/validation-code: ввод кода и SMS
    ├── payments/
    │   ├── transaction/
    │   │   ├── PaymentPage.tsx                — /payments/transaction/payment-page:
    │   │   ├── CardSuccess.tsx                — /payments/transaction/card-success:
    │   │   ├── PaymentPageSingleChoose.tsx    — /payments/transaction/payment-page-single-choose:
    │   │   ├── CardForm.tsx                   — /payments/transaction/card-form:
    │   │   ├── BankList.tsx                   — /payments/transaction/bank-list:
    │   │   ├── M2M.tsx                        — /payments/transaction/m2m:
    │   │   ├── C2C.tsx                        — /payments/transaction/c2c:
    │   │   ├── 3Ds.tsx                        — /payments/transaction/3ds:
    │   │   ├── Polling.tsx                    — /payments/transaction/polling:
    │   │   ├── Error.tsx                      — /payments/transaction/error:
    │   │   ├── Success.tsx                    — /payments/transaction/success:
    │   │   └── PaymentService.tsx             — /payments/transaction/payment-service:
    │   ├── cards/
    │   │   ├── CardDetails.tsx                — /cards/card-details:
    │   │   ├── CardTariffsandConditions.tsx   — /cards/card-tariffsand-conditions:
    │   │   ├── ContactlessPayment.tsx         — /cards/contactless-payment:
    │   │   ├── СardBlock.tsx                  — /cards/card-block:
    │   │   ├── ReplaceСard.tsx                — /cards/replace-card:
    │   │   ├── CardPinCode.tsx                — /cards/card-pin-code:
    │   │   ├── CardLimits.tsx                 — /cards/card-limits:
    │   │   ├── RegistrationNewCard.tsx        — /cards/registration-new-card:
    │   │   ├── СardAllProducts.tsx            — /cards/card-all-products:
    │   │   ├── CardForSomeone.tsx             — /cards/card-for-someone:
    │   │   ├── CardDebit.tsx                  — /cards/card-debit:
    │   │   ├── CardDesign.tsx                 — /cards/card-design:
    │   │   ├── CardSearch.tsx                 — /cards/card-search:
    │   │   ├── CardDeliveryDetails.tsx        — /cards/card-delivery-details:
    │   │   ├── CardDelivery.tsx               — /cards/card-delivery:
    │   │   └── CardСonfirmation.tsx           — /cards/card-confirmation:
    │   └── loans/
    │       └── BNPL.tsx                       — /loans/BNPL:
    ├── finance/
    ...
    ├── history/
    │   ├── HistoryMain.tsx                    — /history/history-main:
    │   ├── HistoryOperationsList.tsx          — /history/history-operationsList:
    │   └── HistoryFilters.tsx                 — /history/history-filters:
    └── loyalty/
        ├── Main.tsx                           — /loyalty/main:
        ├── Referal1.tsx                       — /loyalty/referal1:
        ├── Referal2.tsx                       — /loyalty/referal2:
        ├── Offerwall.tsx                      — /loyalty/offerwall:
        ├── Compensation.tsx                   — /loyalty/compensation:
        └── Catergories.tsx                    — /loyalty/catergories:
```
