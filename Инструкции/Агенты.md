...
└── pages/
    ...
    │   └── FavoritesPage.tsx                  — ...
    ├── authorization/
    │   ├── Authorization.tsx                  — /authorization/authorization: ...
    │   ├── Login.tsx                          — /authorization/loginn: ...
    │   ├── PasswordRecovery.tsx               — /authorization/password-recovery: ...
    │   ├── SelectProfile.tsx                  — /authorization/select-profile: ...
    │   ├── AuthorizationSocialID.tsx          — /authorization/authorization-socia-id: ...
    │   └── Registration.tsx                   — /authorization/registration: ...
    ├── ID
    │   ├── forms/
    │   │   ├── Contacts.tsx                   — /ID/forms/contacts: форма анкеты с контактными данными
    │   │   ├── PersonalData.tsx               — /ID/forms/personal-data: форма анкеты с личными данными
    │   │   ├── Job.tsx                        — /ID/forms/jobs: форма анкеты с данными о работе
    │   │   ├── Income.tsx                     — /ID/forms/income: форма анкеты с данными о доходе
    │   │   ├── Additional.tsx                 — /ID/forms/additional: форма анкеты с дополнительной информацией
    │   │   ├── ObjectOfInsurance.tsx          — /ID/forms/object-of-Insurance: форма анкеты с данными по объекту страхования
    │   │   ├── Mortgage.tsx                   — /ID/forms/mortgage: форма анкеты для ипотеки
    │   │   ├── OSAGO.tsx                      — /ID/forms/osago: форма анкеты для ОСАГО
    │   │   └── KASKO.tsx                      — /ID/forms/kasko: форма анкеты для КАСКО
    │   ├── summary/
    │   │   ├── Items.tsx                      — /ID/summary/items: поля
    │   │   ├── Loan.tsx                       — /ID/summary/loan: рассрочка
    │   │   ├── CreditCard.tsx                 — /ID/summary/credit-card: кредитная карта
    │   │   ├── CarLoan.tsx                    — /ID/summary/car-loan: автокредитование
    │   │   ├── MicroLoan.tsx                  — /ID/summary/micro-loan: микрокредитование
    │   │   ├── Instalment.tsx                 — /ID/summary/instalment: рассрочки
    │   │   ├── Mortgage.tsx                   — /ID/summary/mortgage: ипотека
    │   │   ├── MortgageInsurance.tsx          — /ID/summary/mortgage-insurance: страхование ипотеки
    │   │   ├── OSAGO.tsx                      — /ID/summary/OSAGO: ОСАГО
    │   │   └── KASKO.tsx                      — /ID/summary/KASKO: КАСКО
    │   └── wallet/
    │       ├── Summary.tsx                    — /ID/wallet/summary:
    │       ├── IdentyLeveles.tsx              — /ID/wallet/identy-leveles:
    │       └── PersonalData.tsx               — /ID/wallet/personal-data:
    ├── profile/
    │   ├── ProfilePage.tsx                    — /profile: аватар + меню + Финансы + Logout
    │   ├── ProfileNotifications               — /profile/notifications: уведомления
    │   ├── ProfileSecurity                    — /profile/security: безопасность
    │   ├── ProfileOrders                      — /profile/orders заказы
    │   ├── ProfileFavourites                  — /profile/orders избранное
    │   ├── ProfileFeedback                    — /profile/feedback отзывы и вопросы
    │   ├── ProfileCertificate.tsx             — /profile/сertificate: форма сертификаты
    ...
    ├── snippets/
    │   ├── SuperApp.tsx                       — /snippets/super-app: главны экран приложения
    │   └── categories/
    │       ├── Electronics.tsx                — /snippets/categories/electronics: главный экран категории электорника
    │       ├── Cloth.tsx                      — /snippets/categories/cloth: главный экран категории одежда
    │       ├── Cosmetics.tsx                  — /snippets/categories/cosmetics: главный экран категории косметика
    │       ├── HousesGoods.tsx                — /snippets/categories/houses-goods: главный экран категории товаров для дома
    │       ├── Flower.tsx                     — /snippets/categories/flower: главный экран категории цветы
    │       ├── Food.tsx                       — /snippets/categories/food: главный экран категории продуктов питания
    │       ├── Restaurant.tsx                 — /snippets/categories/restaurant: главный экран категории доставки еды из ресторанов
    │       ├── RealEstate.tsx                 — /snippets/categories/reale-state: главный экран категории недвижимость
    │       ├── Travel.tsx                     — /snippets/categories/travel: главный экран категории краткосрочной аренды
    │       ├── Auto.tsx                       — /snippets/categories/auto: главный экран категории авто
    │       ├── Services.tsx                   — /snippets/categories/services: главный экран категории услуги
    │       └── Jobs.tsx                       — /snippets/categories/jobs: главный экран категории работа
    ├── item-card/
    │   ├── Electronics.tsx                    — /item-card/electronics: катрочка товара из категории электроника
    │   ├── Cloth.tsx                          — /item-card/cloth: катрочка товара из категории одежда
    │   ├── Cosmetics.tsx                      — /item-card/cosmetics: катрочка товара из категории косметика
    │   ├── HousesGoods.tsx                    — /item-card/houses-goods: катрочка товара из категории товаров длядома
    │   ├── Flower.tsx                         — /item-card/flower: катрочка товара из категории цветов
    │   ├── Food.tsx                           — /item-card/food: катрочка товара из категории продуктов питания
    │   ├── Restaurant.tsx                     — /item-card/restaurant: катрочка товара из категории еды из ресторанов
    │   ├── RealEstate.tsx                     — /item-card/real-estate: катрочка объекта из категории недвижимость
    │   ├── Travel.tsx                         — /item-card/travel: катрочка объекта товара из категории краткосрочной аренды
    │   ├── Auto.tsx                           — /item-card/auto: карточка автомобиля
    │   ├── Services.tsx                       — /item-card/services: катрочка вакансии из категории услуги
    │   └── Jobs.tsx                           — /item-card/jobs: катрочка вакансии из категории работа
    ├── delivery/
    │   ├── ChoosingPoint.tsx                  — /delivery/choosing-point: выбор пункта доставки
    │   ├── DeliveryMethod.tsx                 — /delivery/delivery-method: выбор способа доставки
    │   └── MakingAnOrder.tsx                  — /delivery/making-an-order: оформление заказа 
    ├── 2FA
    │   ├── PhoneNumber.tsx                    — /2fa/phone-number: ввод номера телефона
    │   └── ValidationCode.tsx                 — /2fa/validation-code: ввод кода и SMS
    ├── payments/
    │   ├── transaction/
    │   │   ├── PaymentPage.tsx                — /payments/transaction/payment-page: оплата (версия со списком)
    │   │   ├── PaymentPageSingleChoose.tsx    — /payments/transaction/payment-page-single-choose: оплата (версия с селектом)
    │   │   ├── CardForm.tsx                   — /payments/transaction/card-form: карточная форма
    │   │   ├── BankList.tsx                   — /payments/transaction/bank-list: списрк банков
    │   │   ├── M2M.tsx                        — /payments/transaction/m2m: оплата Me2Me оплаты через СБП 
    │   │   ├── C2C.tsx                        — /payments/transaction/c2c: оплата С2С оплаты через СБП 
    │   │   ├── 3Ds.tsx                        — /payments/transaction/3ds: 3Ds
    │   │   ├── Polling.tsx                    — /payments/transaction/polling: поллинг
    │   │   ├── Error.tsx                      — /payments/transaction/error: ошиба
    │   │   ├── Success.tsx                    — /payments/transaction/success: успех
    │   │   └── PaymentService.tsx             — /payments/transaction/payment-service: оплата услуг
    │   ├── cards/
    │   │   ├── CardDetails.tsx                — /cards/card-details: детали карты
    │   │   ├── CardTariffsandConditions.tsx   — /cards/card-tariffsand-conditions: такрифы и условия
    │   │   ├── ContactlessPayment.tsx         — /cards/contactless-payment: бесконтактная оплата
    │   │   ├── СardBlock.tsx                  — /cards/card-block: блокировка карты
    │   │   ├── ReplaceСard.tsx                — /cards/replace-card: перевыпуск карты
    │   │   ├── CardPinCode.tsx                — /cards/card-pin-code: пин-код
    │   │   ├── CardLimits.tsx                 — /cards/card-limits: лимыты по карте
    │   │   ├── RegistrationNewCard.tsx        — /cards/registration-new-card: выпуск новой карты
    │   │   ├── СardAllProducts.tsx            — /cards/card-all-products: оформление продукта
    │   │   ├── CardForSomeone.tsx             — /cards/card-for-someone: оформление заказа конкретной карты
    │   │   ├── CardDebit.tsx                  — /cards/card-debit: выбор дебетовой карты
    │   │   ├── CardDesign.tsx                 — /cards/card-design: выбор дизайна карты
    │   │   ├── CardSearch.tsx                 — /cards/card-search: выбор адреса доставки карты
    │   │   ├── CardDeliveryDetails.tsx        — /cards/card-delivery-details: детали заказа карты
    │   │   ├── CardDelivery.tsx               — /cards/card-delivery: выбор адреса доставки
    │   │   ├── CardSuccess.tsx                — /cards/card-success: успешно оформленная карта
    │   │   └── CardСonfirmation.tsx           — /cards/card-confirmation: подтверждение заказа карты
    │   └── loans/
    │       └── BNPL.tsx                       — /loans/BNPL: рассрочка
    ├── finance/
    ...
    │   └── Data.tsx                           — ...
    ├── checkout/
    │   ├── Electronics.tsx                    — /checkout/electronics: чекаут сделки из категории электроника
    │   ├── Cloth.tsx                          — /checkout/cloth: чекаут сделки из категории одежда
    │   ├── Cosmetics.tsx                      — /checkout/cosmetics: чекаут сделки из категории косметика
    │   ├── HousesGoods.tsx                    — /checkout/houses-goods: чекаут сделки из категории товаров для дома
    │   ├── Flower.tsx                         — /checkout/flower: чекаут сделки из категории цветы
    │   ├── Food.tsx                           — /checkout/food: чекаут сделки из категории еда
    │   ├── Restaurant.tsx                     — /checkout/restaurant чекаут сделки из категории доставка еды и ресторанов
    │   ├── RealEstate.tsx                     — /checkout/real-estate: чекаут сделки из категории недвижимости
    │   ├── Travel.tsx                         — /checkout/travel: чекаут сделки из категории краткосрочной аренды
    │   ├── Auto.tsx                           — /checkout/auto: чекаут сделки из категории авто
    │   ├── Services.tsx                       — /checkout/services: чекаут сделки из категории услуги
    │   └── Jobs.tsx                           — /checkout/jobs: чекаут сделки из категории работа
    ├── history/
    │   ├── HistoryMain.tsx                    — /history/history-main: история операций
    │   ├── HistoryOperationsList.tsx          — /history/history-operationsList: список операций
    │   └── HistoryFilters.tsx                 — /history/history-filters: фильры операций
    └── loyalty/
        ├── Main.tsx                           — /loyalty/main: лояльность
        ├── Referal1.tsx                       — /loyalty/referal1: реферальная программа
        ├── Referal2.tsx                       — /loyalty/referal2: реферальная программа
        ├── Offerwall.tsx                      — /loyalty/offerwall: предложения от партнеров
        ├── Compensation.tsx                   — /loyalty/compensation: возмещение средств
        └── Catergories.tsx                    — /loyalty/catergories: категории кешбека
```
