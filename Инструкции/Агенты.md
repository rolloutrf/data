...
└── pages/
    ...
    │   │   ├── CreditCard.tsx                 — /ID/summary/CreditCard
    │   │   ├── CarLoan.tsx                    — /ID/summary/CarLoan
    │   │   ├── MicroLoan.tsx                  — /ID/summary/MicroLoan
    │   │   ├── Instalment.tsx                 — /ID/summary/Instalment
    │   │   ├── Mortgage.tsx                   — /ID/summary/Mortgage
    │   │   ├── MortgageInsurance.tsx          — /ID/summary/MortgageInsurance
    ...
    │   ├── SuperApp.tsx                       — ...
    │   └── categories/
    │       ├── Electronics.tsx                — /snippets/categories/electronics:
    │       ├── Cloth.tsx                      — /snippets/categories/cloth:
    │       ├── Cosmetics.tsx                  — /snippets/categories/cosmetics:
    │       ├── HousesGoods.tsx                — /snippets/categories/houses-goods:
    │       ├── Flower.tsx                     — /snippets/categories/flower:
    │       ├── Food.tsx                       — /snippets/categories/food:
    │       ├── Restaurant.tsx                 — /snippets/categories/restaurant:
    │       ├── RealEstate.tsx                 — /snippets/categories/reale-state:
    │       ├── Travel.tsx                     — /snippets/categories/travel:
    │       ├── Auto.tsx                       — /snippets/categories/auto:
    │       ├── Services.tsx                   — /snippets/categories/services:
    │       └── Jobs.tsx                       — /snippets/categories/jobs:
    ├── item-card/
    │   ├── Electronics.tsx                    — /item-card/electronics:
    │   ├── Cloth.tsx                          — /item-card/cloth:
    │   ├── Cosmetics.tsx                      — /item-card/cosmetics:
    │   ├── HousesGoods.tsx                    — /item-card/houses-goods:
    │   ├── Flower.tsx                         — /item-card/flower:
    │   ├── Food.tsx                           — /item-card/rood:
    │   ├── Restaurant.tsx                     — /item-card/restaurant:
    │   ├── RealEstate.tsx                     — /item-card/real-estate:
    │   ├── Travel.tsx                         — /item-card/travel:
    │   ├── Auto.tsx                           — /item-card/auto:
    │   ├── Services.tsx                       — /item-card/services:
    │   └── Jobs.tsx                           — /item-card/jobs:
    ├── delivery/
    ...
    ├── 2FA
    │   ├── PhoneNumber.tsx                    — /2fa/phone-number:
    │   └── ValidationCode.tsx                 — /2fa/validation-code:
    ├── payments/
    │   ├── transaction/
    ...
    │   └── Data.tsx                           — ...
    ├── checkout/
    │   ├── Electronics.tsx                    — /checkout/electronics:
    │   ├── Cloth.tsx                          — /checkout/cloth:
    │   ├── Cosmetics.tsx                      — /checkout/cosmetics:
    │   ├── HousesGoods.tsx                    — /checkout/houses-goods:
    │   ├── Flower.tsx                         — /checkout/flower:
    │   ├── Food.tsx                           — /checkout/food:
    │   ├── Restaurant.tsx                     — /checkout/restaurant
    │   ├── RealEstate.tsx                     — /checkout/real-estate:
    │   ├── Travel.tsx                         — /checkout/travel:
    │   ├── Auto.tsx                           — /checkout/auto:
    │   ├── Services.tsx                       — /checkout/services:
    │   └── Jobs.tsx                           — /checkout/jobs:
    ├── history/
